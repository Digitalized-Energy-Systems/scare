...
_REGULATIONS = {
    ...
    130: 0.0,
    138: 0.0,
    221: 0.9947553216343291,
    227: 0.9906953226187393,
    239: 0.991636328549582,
    251: 0.9999999396472401,
    252: 0.9992252850297415,
    266: 0.0,
    308: 0.7,
    316: 0.7,
    320: 0.7,
...
def test_headroom_scales_the_active_rating():
    ...
    apply_microgrid_islanding(
        net, promote_all_generators=True, grid_former_headroom=3.0
    )
...
def test_headroom_one_restores_setpoint_pinned_behaviour():
    ...
    apply_microgrid_islanding(
        net, promote_all_generators=True, grid_former_headroom=1.0
    )
...
def test_headroom_never_shrinks_the_rating():
    net = GRIDS["simbench_lv_small"]()
    apply_microgrid_islanding(
        net, promote_all_generators=True, grid_former_headroom=0.1
    )
    ref = GRIDS["simbench_lv_small"]()
    apply_microgrid_islanding(
        ref, promote_all_generators=True, grid_former_headroom=1.0
    )
