"""ADMM flex-actor wrappers for each coupling plant type (CHP / P2G / G2P / P2H).

Each resolves device capacity in MW and packages it with a sector-efficiency
vector + uniform priority.
"""
