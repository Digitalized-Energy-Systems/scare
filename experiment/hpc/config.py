...
class ExperimentSpec:
    ...
    # Aggregation hint (NOT expanded into tasks): justification-summary delta
    # columns, measured over ``population``; first is primary (drives the effect
    # screen), empty => legacy PWSF tables. See experiment/configs/CONFIG_JUSTIFICATION.md.
